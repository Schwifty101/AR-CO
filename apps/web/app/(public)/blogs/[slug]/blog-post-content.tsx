...
/**
 * Client component that renders the full blog post with animations.
 * Fetches post by slug and increments the view counter.
 *
 * @example
 * ```tsx
 * <BlogPostContent slug="personal-injury-claims-guide" />
 * ```
 */
