...
/**
 * RegisteredClientsTable Component
 *
 * Self-contained component that displays a paginated, searchable, and filterable
 * table of all registered clients in the admin panel. Includes the Add Client
 * dialog, filter bar, client data table, and pagination controls.
 *
 * Manages its own data fetching, state, and navigation. Designed to be rendered
 * within the tabbed layout on the admin clients page.
 *
 * @module RegisteredClientsTable
 *
 * @example
 * ```tsx
 ...
 * @returns Formatted date string (e.g., "Feb 16, 2026")
 *
 * @example
 * ```ts
 * formatDate('2026-02-16T12:00:00Z'); // "Feb 16, 2026"
 * ```
 */
...
/**
 * Registered clients table with full CRUD, search, filter, and pagination.
 *
 * Renders the Add Client button/dialog, a card with search/filter bar, the
 * clients data table, loading skeletons, empty state, error state, and
 * pagination controls.
 *
 * @returns The complete registered clients UI
 */
export default function RegisteredClientsTable() {
  ...
  /** Create a new client from the dialog form */
  ...
  /** Handle dialog open/close with form reset on close */
